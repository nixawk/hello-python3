...
class LazyEchoServer(object):
    ...
    def serve_forever(self):
        ...
        while self.inputs:
            ...
            for sock in readable: self.handle_readable_sock(sock)
            for sock in writable: self.handle_writable_sock(sock)
            for sock in exceptional: self.handle_exceptional_sock(sock)
